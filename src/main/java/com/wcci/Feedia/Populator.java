...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        reptile1.myCalendar.createEvent("Feed Yo Lizzzzard", "My Lizard's House", "I've gotta remember to feed this guy",
        ...
        Reptile reptile2 = new Reptile("Cayde", "Leopard Gecko", 6, "Male","../images/cayde.png", "He don't like being touched", 0f, 0f);
...
//        reptileRepo.save(reptile1);
        ...
        Note note2 = new Note("Observation:", "Tried to eat newspaper.", true, reptile1);
        noteRepo.save(note2);
//        note2.setReptile(reptile2);
//        reptileRepo.save(reptile2);

        Note note3 = new Note("Observation:", "Tried to climb up the glass again.", true, reptile1);
        noteRepo.save(note3);
//        note3.setReptile(reptile3);
//        reptileRepo.save(reptile3);

        Note note4 = new Note("Observation:", "Couldn't find a few crickets.", true, reptile1);
        noteRepo.save(note4);
